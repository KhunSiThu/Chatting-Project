...
<div id="friendProfileShowCon" class="hidden mb-10 w-full overflow-auto relative bg-white text-gray-900 dark:bg-gray-900 dark:text-white scroll-none">
    ...
    <section class="profileCoverImg relative block h-48 sm:h-64 md:h-80 lg:h-96 bg-slate-300 dark:bg-gray-950">
        <img alt="cover"
            src="https://www.pixelstalk.net/wp-content/uploads/images6/Aesthetic-Minimalist-Wallpaper-Paper-Airplanes.png"
            class="w-full h-full object-cover">
    </section>
...
<div id="updateCoverImageModal" class="bg-blur hidden w-full h-screen flex justify-center items-center z-50 fixed inset-0">
    <div class="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-lg shadow-xl p-10 relative">
        ...
        <div class="flex gap-4 mt-6">
            <button id="resetButton" class="w-1/2 bg-red-500 dark:bg-red-600 text-white py-3 px-6 rounded-lg shadow-lg font-semibold text-lg transition duration-300 hover:bg-red-600 dark:hover:bg-red-700" onclick="resetCoverImage()">
                Reset
            </button>
            <button id="coverSubmitButton" class="w-1/2 bg-green-500 dark:bg-green-600 text-white py-3 px-6 rounded-lg shadow-lg font-semibold text-lg transition duration-300 hover:bg-green-600 dark:hover:bg-green-700 cursor-not-allowed opacity-50" disabled>
                Submit
            </button>
        </div>
    </div>
...
<div id="updateProfileImageModal" class="bg-blur hidden w-full h-screen flex justify-center items-center z-50 fixed inset-0">
    <div class="w-full max-w-xl bg-white dark:bg-gray-800 rounded-lg shadow-xl p-10 relative">
        ...
        <h1 class="text-3xl font-extrabold text-center text-gray-800 dark:text-gray-200 mb-4">Update Your Profile Image</h1>
        <p class="text-center text-gray-500 dark:text-gray-400 mb-6">Choose an image to personalize your profile.</p>
        ...
        <div class="flex gap-4 mt-6">
            <button id="resetButton" class="w-1/2 bg-red-500 dark:bg-red-600 text-white py-3 px-6 rounded-lg shadow-lg font-semibold text-lg transition duration-300 hover:bg-red-600 dark:hover:bg-red-700" onclick="resetProfileImage()">
                Reset
            </button>
            <button id="profileSubmitButton" class="w-1/2 bg-green-500 dark:bg-green-600 text-white py-3 px-6 rounded-lg shadow-lg font-semibold text-lg transition duration-300 hover:bg-green-600 dark:hover:bg-green-700 cursor-not-allowed opacity-50" disabled>
                Submit
            </button>
        </div>
    </div>
...
<!-- Post Creation Form -->
<div id="postCreateForm" class="w-11/12 md:w-2/3 mx-auto p-6 my-10 bg-gray-100 shadow-lg rounded-lg dark:bg-gray-800" style="max-height:550px;">
