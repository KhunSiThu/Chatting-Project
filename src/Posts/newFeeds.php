    ...
    <div class="w-11/12 md:w-2/3 mx-auto" style="max-height:550px;">
        ...
        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg my-12">
            <div class="flex items-center space-x-3">
                <img src="<?= $profileImage ?>" class="w-10 h-10 object-cover rounded-full" />
           ...
           ORDER BY posts.createdAt DESC";
            ...
            ?>
                    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
                        <!-- User Info -->
                        <div class="flex items-center space-x-3">
                            <img src="../Uploads/<?= htmlspecialchars($row['profileImage']) ?>" class="w-10 h-10 object-cover rounded-full" />
                            <div>
