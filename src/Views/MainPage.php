...
?>
    <main class="flex flex-col md:flex-row min-h-screen">
        ...
        <div id="sidebar" class="relative flex md:flex h-screen md:w-auto bg-white dark:bg-gray-800 border-e border-gray-200 dark:border-gray-700 z-40" >
            <nav class="md:relative fixed bottom-0 z-40 md:h-full w-full h-20 md:w-24 flex justify-between  items-center md:flex-col bg-gray-200/90 dark:bg-gray-900/90 rounded-xl md:rounded-none md:bg-white md:dark:bg-gray-800 md:border-e border-2 border-blue-400 md:border-gray-200 md:dark:border-gray-700 mb-3 shadow-lg">
